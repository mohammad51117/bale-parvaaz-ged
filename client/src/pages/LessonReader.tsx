...
export default function LessonReader() {
  ...
  const content = sourceContent ? { lesson: sourceContent.lessonSummary, keyMove: sourceContent.focusPoints.join(" "), workedExample: sourceContent.sourceExcerpt, question: sourceContent.question, choices: sourceContent.choices, answer: sourceContent.answer, explanation: sourceContent.explanation, finishRule: sourceContent.finishRule, sourcePage: sourceContent.sourcePage, sourceStart: sourceContent.sourceStart, sourceEnd: sourceContent.sourceEnd } : genericContent ? { ...genericContent, sourcePage: null, sourceStart: null, sourceEnd: null } : null;
  ...
  useEffect(() => { setSelected(null); setChecked(false); setCompleted(getCompleted().includes(lessonId)); setSourcePageIndex(0); }, [lessonId]);
  ...
  const sourceStart = content.sourceStart || content.sourcePage || 1;
